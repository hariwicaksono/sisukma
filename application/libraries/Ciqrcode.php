...
class Ciqrcode {
	...
	function __construct($config = array()) {
		...
		include dirname(__FILE__) . "/phpqrcode/qrconst.php";
		include dirname(__FILE__) . "/phpqrcode/qrtools.php";
		include dirname(__FILE__) . "/phpqrcode/qrspec.php";
		include dirname(__FILE__) . "/phpqrcode/qrimage.php";
		include dirname(__FILE__) . "/phpqrcode/qrinput.php";
		include dirname(__FILE__) . "/phpqrcode/qrbitstream.php";
		include dirname(__FILE__) . "/phpqrcode/qrsplit.php";
		include dirname(__FILE__) . "/phpqrcode/qrrscode.php";
		include dirname(__FILE__) . "/phpqrcode/qrmask.php";
		include dirname(__FILE__) . "/phpqrcode/qrencode.php";
