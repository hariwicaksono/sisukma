...
class Selesai extends CI_Controller {
	...
	public function selesaiDetail($id_selesai = null, $kd_surat = null){
		...
		if($selesai->id_selesai == $id_selesai && $selesai->kd_surat == $kd_surat){
			...
			switch ($selesai->kd_surat) {
				...
				$data['page'] = $selesai->nm_surat;
				$this->template->load('admin/layout/admin_template','selesai/SP-KP',$data);
	...
	public function printSelesai($id_selesai = null, $kd_surat = null){
