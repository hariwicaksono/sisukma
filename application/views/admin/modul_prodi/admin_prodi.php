      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-sm-6">
            ...
            <a class="btn btn-outline-primary" href="<?= base_url('admin/dProdiAdd')?>">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item"><a href="<?= base_url('admin/dProdi')?>"><?= $page ;?></a></li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
              ...
              <table id="example" class="table table-bordered table-striped display nowrap" style="width:100%">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <a style="margin-right:10px" href="<?= base_url('admin/dProdiDetail/'.$this->encrypt->encode($pro->kdpro).'')?>" title="Detail"><i class="fas fa-eye text-primary"></i></a>
                      <a style="margin-right:10px" href="<?= base_url('admin/dProdiEdit/'.$this->encrypt->encode($pro->kdpro).'')?>" title="Edit"><i class="fas fa-edit text-secondary"></i></a>
