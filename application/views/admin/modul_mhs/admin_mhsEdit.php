        ...
        <div class="card">
          ...
          <form class="form-horizontal" action="<?= base_url('admin/dMahasiswaEdit/'). $this->encrypt->encode($onemhs->nim).'';?>" method="post">
            <div class="card-body">
              ...
              <input type="hidden" name="zz" value="<?= $onemhs->nim ;?>">
              ...
              <div class="form-group row ml-3 mr-3">
                ...
                <div class="col-sm-10">
                  <input type="text" name="nama" class="form-control" id="editMhsNm" placeholder="Nama Mahasiswa" value="<?= $onemhs->nmmhs ;?>">
              ...
              <div class="form-group row ml-3 mr-3">
                ...
                <div class="col-sm-10">
                  <div class="input-group">
                    ...
                    <input type="text" id="editMhsThAka" name="angkatan" class="form-control" value="<?= $onemhs->thaka?>" data-inputmask='"mask": "9999/9999"' Placeholder="2013/2014" data-mask>
                  </div>
              ...
              <div class="form-group row ml-3 mr-3">
                ...
                <div class="col-sm-10">
                  ...
                  <!--                   <input type="text" name="status" class="form-control" id="editMhsStatus" placeholder="Status" value="<?= $onemhs->status ;?>"> -->
              ...
              <div class="form-group row ml-3 mr-3">
                ...
                <div class="col-sm-3">
                  <input type="text" name="tempat" class="form-control mb-2" id="editMhsTpt/TglLhr" placeholder="Tempat" value="<?= $onemhs->tptlhr ;?>">
                ...
                <div class="col-sm-3" >
                  <div class="input-group date" data-provide="datepicker">
                    ...
                    <input type="text" name="tanggal" class="form-control float-right" id="tglLhr" value="<?= date('F d Y', strtotime($onemhs->tgllhr)) ;?>" >
                  </div>
              ...
              <div class="form-group row ml-3 mr-3">
                ...
                <div class="col-sm-10">
                  <input type="text" name="alamat" class="form-control" id="editMhsAlamat" placeholder="Alamat" value="<?= $onemhs->alamat ;?>">
              ...
              <div class="form-group row ml-3 mr-3">
                ...
                <div class="col-sm-10">
                  <input type="text" name="ortu" class="form-control" id="editMhsNmOrtu" placeholder="Alamat" value="<?= $onemhs->nmortu ;?>">
              ...
              <div class="form-group row ml-3 mr-3">
                ...
                <div class="col-sm-10">
                  <div class="input-group">
                    ...
                    <input type="email" id="editMhsEmail" name="email" class="form-control" placeholder="someone@someone.com / someone@someone.co.id" value="<?= $onemhs->email?>">
                  </div>
              ...
              <div class="form-group row ml-3 mr-3">
                ...
                <div class="col-sm-10">
                  <div class="input-group">
                    ...
                    <input type="text" id="editMhsTelp" name="tlp" class="form-control" value="<?= $onemhs->telp?>" data-inputmask='"mask": "9999-9999-99999"' placeholder="9999-9999-99999" data-mask>
                  </div>
                  <?php echo form_error('email', '<small class="text-danger pl-3">', '</small>');?>
                </div>
              </div>
              <div class="form-group row ml-3 mr-3">
                ...
                <div class="col-sm-10">
                  <input type="text" name="kelas" class="form-control" id="editMhsKelas" placeholder="Kelas" value="<?= $onemhs->kelas ;?>">
            ...
            <div class="card-footer justify-content-between">
              ...
              <button type="submit" class="btn btn-primary"><i class="fas fa-edit"></i>&ensp;Simpan</button>
            </div>
          </form>
        </div>
        <!-- /.card -->
