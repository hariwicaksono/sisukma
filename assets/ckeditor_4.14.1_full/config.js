 ...
 */
 ...
 CKEDITOR.editorConfig = function( config ) {
	...
	// config.contentsCss = [ 
	// 'http://esurat.pspti.or.id/assets/ckeditor_4.14.1_full/contents.css', 
	// 'http://esurat.pspti.or.id/assets/ckeditor_4.14.1_full/mystyles.css' 
	// ];
	// config.filebrowserBrowseUrl = 'http://esurat.pspti.or.id/assets/kcfinder-2.51/browse.php?type=files';
	// config.filebrowserImageBrowseUrl = 'http://esurat.pspti.or.id/assets/kcfinder-2.51/browse.php?type=images';
	// config.filebrowserFlashBrowseUrl = 'http://esurat.pspti.or.id/assets/kcfinder-2.51/browse.php?type=flash';
	// config.filebrowserUploadUrl = 'http://esurat.pspti.or.id/assets/kcfinder-2.51/upload.php?type=files';
	// config.filebrowserImageUploadUrl = 'http://esurat.pspti.or.id/assets/kcfinder-2.51/upload.php?type=images';
	// config.filebrowserFlashUploadUrl = 'http://esurat.pspti.or.id/assets/kcfinder-2.51/upload.php?type=flash';
